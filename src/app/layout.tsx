...
export const metadata: Metadata = {
  title: "SONY Professional Presentation Cameras | 4K Video & Photography",
  description: "Discover SONY's professional presentation cameras with 4K recording, advanced stabilization, and intelligent autofocus. Perfect for content creators and professionals.",
  keywords: "SONY cameras, presentation cameras, 4K video recording, professional photography, camera equipment, video production",
  metadataBase: new URL("https://www.sony.com/cameras/presentation"),
  alternates: {
    canonical: "https://www.sony.com/cameras/presentation"
  },
  openGraph: {
    title: "SONY Professional Presentation Cameras | 4K Video & Photography",
    description: "Discover SONY's professional presentation cameras with 4K recording, advanced stabilization, and intelligent autofocus. Perfect for content creators and professionals.",
    url: "https://www.sony.com/cameras/presentation",
    siteName: "SONY",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763560810307-45jnuz10.jpg",
      alt: "SONY professional presentation camera"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "SONY Professional Presentation Cameras | 4K Video & Photography",
    description: "Discover SONY's professional presentation cameras with 4K recording, advanced stabilization, and intelligent autofocus.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763560810307-45jnuz10.jpg"]
  },
  robots: {
    index: true,
    follow: true
